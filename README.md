...
<img src="https://skillicons.dev/icons?i=flask,fastapi,django,spring,flutter,dart&theme=dark" alt="Frameworks" /><br><br>
<img src="https://skillicons.dev/icons?i=docker,git,github,linux,vscode,wordpress&theme=dark" alt="Tools" /><br><br>
<img src="https://skillicons.dev/icons?i=postgres,mysql,mongodb,nodejs,bash,figma&theme=dark" alt="Other" />
</div>
...
![Apache](https://img.shields.io/badge/Apache-D22128?style=for-the-badge&logo=apache&logoColor=white&labelColor=1a1b27)
...
![Stripe](https://img.shields.io/badge/Stripe-635BFF?style=for-the-badge&logo=stripe&logoColor=white&labelColor=1a1b27)
![WooCommerce](https://img.shields.io/badge/WooCommerce-96588A?style=for-the-badge&logo=woocommerce&logoColor=white&labelColor=1a1b27)
...
|---------|------------|------|
| [**Skipy_flask**](https://github.com/LuisEduardoGE/Skipy_flask) | Production REST API for a food court ordering platform — real-time WebSocket notifications, Stripe payments, WooCommerce integration, multi-store order management | ![Flask](https://img.shields.io/badge/-Flask-000?style=flat-square&logo=flask&logoColor=white) ![Stripe](https://img.shields.io/badge/-Stripe-635BFF?style=flat-square&logo=stripe&logoColor=white) ![MySQL](https://img.shields.io/badge/-MySQL-4479A1?style=flat-square&logo=mysql&logoColor=white) |
| [**VascoDaGamaMarketplace**](https://github.com/LuisEduardoGE/VascoDaGamaMarketplace) | Mobile-first marketplace app for Centro Comercial Vasco da Gama (Lisbon) — 60+ shops, floor navigation, search, filtering, ratings, integrated with Skipy ordering | ![JavaScript](https://img.shields.io/badge/-JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black) ![HTML5](https://img.shields.io/badge/-HTML5-E34F26?style=flat-square&logo=html5&logoColor=white) |
| [**fastapi-vs-drf-comparison**](https://github.com/LuisEduardoGE/fastapi-vs-drf-comparison) | In-depth side-by-side comparison of FastAPI vs Django REST Framework — same Todo API built in both, with detailed documentation and benchmarks | ![FastAPI](https://img.shields.io/badge/-FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white) ![Django](https://img.shields.io/badge/-Django-092E20?style=flat-square&logo=django&logoColor=white) |
| [**qr-code-creator**](https://github.com/LuisEduardoGE/qr-code-creator) | QR code generator with custom logo embedding, rounded corners, SVG support, and automatic image conversion via Inkscape/ImageMagick | ![Python](https://img.shields.io/badge/-Python-3776AB?style=flat-square&logo=python&logoColor=white) ![Pillow](https://img.shields.io/badge/-Pillow-3776AB?style=flat-square&logo=python&logoColor=white) |
| [**Skipy**](https://github.com/LuisEduardoGE/Skipy) | Landing page for the Skipy platform — scan QR, order online, get SMS notifications, collect your meal | ![Flask](https://img.shields.io/badge/-Flask-000?style=flat-square&logo=flask&logoColor=white) ![CSS](https://img.shields.io/badge/-CSS-1572B6?style=flat-square&logo=css3&logoColor=white) |
| [**OutSourceIT**](https://github.com/LuisEduardoGE/OutSourceIT) | Business website for an IT outsourcing venture with animated particle backgrounds | ![HTML5](https://img.shields.io/badge/-HTML5-E34F26?style=flat-square&logo=html5&logoColor=white) ![Particles.js](https://img.shields.io/badge/-Particles.js-000?style=flat-square) |
| [**Space.github.io**](https://github.com/LuisEduardoGE/Space.github.io) | Creative space-themed website with procedural star generation, parallax scrolling, and interactive falling star animations | ![CSS](https://img.shields.io/badge/-CSS-1572B6?style=flat-square&logo=css3&logoColor=white) ![JavaScript](https://img.shields.io/badge/-JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black) |
